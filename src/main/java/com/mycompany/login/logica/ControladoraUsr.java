...
public class ControladoraUsr {
    
    ControladoraPersistenciaUsr controlPersis;// = new ControladoraPersistenciaUsr();

    public ControladoraUsr() {
        controlPersis = new ControladoraPersistenciaUsr();
    }
